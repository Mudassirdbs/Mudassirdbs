...
- 🏢 Building my own agency brand at **[rankif.agency](https://rankif.agency)**
- 🎓 CS student — coursework in Cyber Security, Compiler Design, Computer Vision & Parallel Computing
- 📈 Currently on a 12-week roadmap to level up my **MERN stack** skills
- ✍️ Bilingual creator — comfortable writing in both English and Urdu
...
- 🧩 Embeddable WordPress widgets — calculators, comparison tools, testimonial grids
- 🧠 Learning the MERN stack in depth (target: October 2026)
- 🔍 SEO-driven websites and content optimization for global clients
...
|---|---|---|
| **[logical_analyzer](https://github.com/Mudassirdbs/logical_analyzer)** | Analysis / logic tool | TypeScript |
| **[soundcloud_downloader](https://github.com/Mudassirdbs/soundcloud_downloader)** | SoundCloud mp3 downloader | Python |
| **[studocu_downloader](https://github.com/Mudassirdbs/studocu_downloader)** | Document downloader tool | JavaScript |
| **[Colorwise](https://github.com/Mudassirdbs/Colorwise)** | Suggests colors based on skin & hair tone | JavaScript |
| **[website-cloner](https://github.com/Mudassirdbs/website-cloner)** | MIT-licensed site cloning tool | TypeScript |
