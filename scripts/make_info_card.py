...
# ===========================================================================
HOST = "mudassir"   # shown as  mudassir@github  in the header

ROWS = [
    ("host",),
    ("kv", "Full Stack", "Full-stack AI & Web Development"),
    ("kv", "AI / ML", "LangChain, OpenAI, Claude, RAG"),
    ("kv", "Frontend", "React, Next.js, TypeScript, Tailwind"),
    ("kv", "Backend", "Node.js, Python, PostgreSQL, APIs"),
    ("gap",),
    ("sec", "Stack"),
    ("bul", "Cloud: AWS, GCP, Azure"),
    ("bul", "Databases: PostgreSQL, MongoDB"),
    ("bul", "DevOps: Docker, CI/CD, GitHub Actions"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "AI prompt engineering & fine-tuning"),
    ("bul", "Full-stack SaaS development"),
]
